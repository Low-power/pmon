...
#define MC_INTERLEAVE_OFFSET 8 //only work when NO_INTERLEAVE is not defined.(32 or above is not tested!!)
#######################################################
...
#define SDRAM_WIDTH_OFFSET  7
#define MC1_SDRAM_WIDTH_OFFSET 39
...
#define DDR_WIN_BASE_ADDR 0x80000000
